...
class DbusSenecEnfluriService:
  def __init__(self, servicename, deviceinstance, paths, productname='Senec EnFluRi', connection='EnFluRi over Senec HTTP JSON service'):
    ...
    self._dbusservice.add_path('/ProductId', 65535) # found on https://www.sascha-curth.de/projekte/005_Color_Control_GX.html#experiment - should be an ET340 Engerie Meter
  ...
  def _getSenecSerial(self):
    meter_data = self._getSenecEnfluriData()  
...
def main():
  ...
  try:
      ...
      pvac_output = DbusSenecEnfluriService(
